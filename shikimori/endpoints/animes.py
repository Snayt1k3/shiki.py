...
class AnimeEndpoint(BaseEndpoint):
    ...
    async def list(self, page: int = None, limit: int = None, order: str = None, kind: str = None, status: str = None,
                   season: str = None, score: str = None,
                   duration: str = None, rating: str = None, genre: str = None, studio: str = None,
                   franchise: str = None, censored: str = None, mylist: str = None,
                   ids: str = None, exclude_ids: str = None, search: str = None,
                   access_token: str = None) -> list[Anime] | RequestError:
        """
        ...
        response = await self._request.make_request("GET", url=f"{self._base_url}/api/animes",
                                                    query_params=filter_none_parameters(
                                                        {"page": page, "limit": limit, "order": order, "kind": kind,
                                                         "status": status, "season": season, "studio": studio,
                                                         "score": score, "duration": duration, "rating": rating,
                                                         "genre": genre, "franchise": franchise, "censored": censored,
                                                         "mylist": mylist, "ids": ids, "exclude_ids": exclude_ids,
                                                         "search": search
                                                         }),
        ...
        if not isinstance(response, RequestError):
            return [Anime(**anime, image=Photo(**anime.get("image"))) for anime in response]
    ...
    async def byId(self, id: int) -> AnimeInfo | RequestError:
        response = await self._request.make_request("GET", url=f"{self._base_url}/api/animes/{id}",
    ...
    async def roles(self, id: int) -> List[Role] | RequestError:
        response = await self._request.make_request("GET", url=f"{self._base_url}/api/animes/{id}/roles",
                                                    headers={"User-Agent": self._user_agent})

        if not isinstance(response, RequestError):
            return [Role(**role, character=Character(**role.get("character"))) for role in response]
    ...
    async def similar(self, id: int) -> List[Anime] | RequestError:
        response = await self._request.make_request("GET", url=f"{self._base_url}/api/animes/{id}/similar",
                                                    headers={"User-Agent": self._user_agent})
    ...
    async def related(self, id: int) -> List[Relation] | RequestError:
        response = await self._request.make_request("GET", url=f"{self._base_url}/api/animes/{id}/related",
                                                    headers={"User-Agent": self._user_agent})

        if not isinstance(response, RequestError):
            return [Relation(**relation,
                             anime=Anime(**relation.get("anime"),
                                         image=Photo(
                                             **relation["anime"]["image"]) if relation.get("anime") else None),
                             manga=Manga(**relation.get("manga"),
                                         image=Photo(**relation["anime"]["image"]) if relation.get("manga") else None))
    ...
    async def screenshots(self, id: int) -> List[ScreenShot] | RequestError:
        response = await self._request.make_request("GET", url=f"{self._base_url}/api/animes/{id}/screenshots",
                                                    headers={"User-Agent": self._user_agent})
    ...
    async def franchise(self, id: int) -> Franchise | RequestError:
        response = await self._request.make_request("GET", url=f"{self._base_url}/api/animes/{id}/franchise",
                                                    headers={"User-Agent": self._user_agent})

        if not isinstance(response, RequestError):
            return Franchise(nodes=[Node(**node) for node in response.get("nodes")],
    ...
    async def externalLinks(self, id: int) -> List[ExternalLink] | RequestError:
        response = await self._request.make_request("GET", url=f"{self._base_url}/api/animes/{id}/external_links",
                                                    headers={"User-Agent": self._user_agent})
    ...
    async def topics(self, id: int, page: int = None, limit: int = None, kind: str = None, episode: int = None) \
            -> List[Topic] | RequestError:
        response = await self._request.make_request("GET", url=f"{self._base_url}/api/animes/{id}/topics",
                                                    headers={"User-Agent": self._user_agent},
                                                    query_params=filter_none_parameters({
                                                        "page": page,
                                                        "limit": limit,
            ...
            return [
                Topic(
                    **topic,
                    ...
                    user=User(**topic.get("user"),
                              image=PhotoExtended(**topic["user"]["image"])
                              ),
                    linked=Linked(**topic["linked"], image=Photo(**topic["linked"]["image"]))
                )
