...
@pytest.mark.asyncio
async def test_franchise_success(manga_client, mangas_franchise_json, mangas_franchise_resp):
...
@pytest.mark.asyncio
async def test_ExternalLinks_success(manga_client, mangas_ExternalLinks_json, mangas_ExternalLinks_resp):
