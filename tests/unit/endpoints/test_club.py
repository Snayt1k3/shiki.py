...
@pytest.mark.asyncio
async def test_characters_success(club_client, club_characters_resp, club_characters_json):
...
@pytest.mark.asyncio
async def test_collections_success(club_client, club_collection_json, club_collection_resp):
