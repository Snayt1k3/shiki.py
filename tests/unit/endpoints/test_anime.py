...
@pytest.mark.asyncio
async def test_screenshots_success(
    anime_client, animes_screenshots_json, animes_screenshots_resp
):
...
async def test_franchise_success(
    anime_client, animes_franchise_json, animes_franchise_resp
):
...
async def test_externalLinks_success(
    anime_client, animes_external_json, animes_external_resp
):
